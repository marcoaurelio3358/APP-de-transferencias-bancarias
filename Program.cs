...
namespace DIO.Bank
{
	class Program
	{
		...
		private static void Depositar()
		{
			...
			Console.Write("Digite o valor em dinheiro a ser depositado na conta: ");
		...
		private static void Sacar()
		{
			...
			Console.Write("Digite o valor em dinheiro a ser sacado da conta: ");
		...
		private static void Transferir()
		{
			...
			Console.Write("Digite o valor em dinheiro a ser transferido: ");
		...
		{
			Console.WriteLine();
			Console.WriteLine("Capital Bank a seu dispor!!!");
